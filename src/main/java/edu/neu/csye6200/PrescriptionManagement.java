...
public class PrescriptionManagement extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Prescription Management");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PrescriptionManagement.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
